...
export default function Contact() {
  ...
  return (
    <>
      <div
        name='contact'
        className='w-full  bg-blue to-gray-800 p-12 pt-24 text-lbgray'
      >
      ...
      {/* <div className='hidden xl:flex w-full bg-dblue justify-end px-8 h-12 '>
        <p className='text-lbgray pt-4'>Designed by Octa</p>
      </div> */}
    </>
  )
}
